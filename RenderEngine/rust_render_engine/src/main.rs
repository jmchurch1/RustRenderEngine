...
fn main() -> Result<()> {
    ...
    let window = WindowBuilder::new()
        .with_title("Vulkan Render Engine")
...
) -> Result<Instance> 
{
    let application_info = vk::ApplicationInfo::builder()
        .application_name(b"Vulkan Render Engine\0")
...
unsafe fn create_pipeline(device: &Device, data: &mut AppData) -> Result<()>
{
    ...
    let rasterization_state = vk::PipelineRasterizationStateCreateInfo::builder()
        ...
        // can set to PolygonMode::FILL, PolygonMode::LINE, or PolygonMode::POINT
...
) -> Result<Device>
{
    ...
    data.graphics_queue = device.get_device_queue(indices.present, 0);
